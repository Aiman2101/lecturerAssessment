...
<div class = "container">
  ...
  if(isset($_SESSION['section1']) && isset($_SESSION['section2']) && isset($_SESSION['section3'])){
    if(round(htmlentities($_SESSION['overallPercent']),2) == 100){
      ...
      echo '<table class="table-primary" text-align: center;> <tr class="table-warning"> <td colspan="3"> <h2>Your lecturer performance is above average!</h2> <p>Your lecturer is doing his/her best.</p> </td> </tr>';

    }

    else if(round(htmlentities($_SESSION['overallPercent']),2) >= 25){
      echo '<table class="table-primary" text-align: center;> <tr class="table-warning"> <td colspan="3"> <h2>Your lecturer performance is average!</h2> <p>.</p> </td> </tr>';
